...
//
// class ElectionCandidatesProvider extends HttpRequest {
//     constructor () {
//         // api api
//         super()
//     }
...
//         })
//
//         const {data} = await this.update('categoryProducts/'+candidate_id,bodyFormData)
//
//
//         return data
//     }
...
//
//         // example path http://172.28.26.82:7001/this.get()
//         const {data} = await this.delete('categoryProducts/'+candidate_id)
//
//         return data
//     }
// }
//
// export default ElectionCandidatesProvider